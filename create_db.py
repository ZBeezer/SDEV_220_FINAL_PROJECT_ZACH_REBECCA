...
# Product data
products = [
    ("Glock 19", "Handgun", 549.99, 10, "Compact 9mm pistol", "HG001"),
    ...
    ("Vortex Strike Eagle 1-6x24", "Optic", 299.99, 12, "Variable zoom rifle scope", "OP001"),
...
# Insert data 
cursor.executemany('''
INSERT INTO products (name, category, price, stock_quantity, description, sku)
VALUES (?, ?, ?, ?, ?, ?)
''', products)
